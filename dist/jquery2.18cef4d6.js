...
window.$ = window.jQuery = function (se) {
  ...
  var api = Object.create(jQuery.prototype); //   api.elements = elements;
...
jQuery.fn = jQuery.prototype = {
  ...
  find: function find(sel) {
    ...
    for (var w = 0; w < this.elements.length; w++) {
      var res1 = Array.from(this.elements[w].querySelectorAll(sel));
      res = res.concat(res1);
    } //return res; //在这里不应该return res；res只是获取到的元素组成的数组，所以要思考返回什么，而且注意返回了之后，若想回到上一级,去操作上一级的elements，要怎么做？
...
},{}]},{},["C:/Users/18234/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","jquery2.js"], null)
