...
console.log("hi");
var a = window.jQuery("#test1");
console.log(a);
var b = a.addClass("red");
console.log(b);
b.addClass("orange"); //console.log(a === b);//结果为true
...
console.log(f);
f.print();
var tt = $("<div id='ttt' style='background:pink;border:5px solid green;padding:20px;'></div>");
console.log(tt);
$("#test2").append(tt);
...
},{}]},{},["C:/Users/18234/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","main1.js"], null)
